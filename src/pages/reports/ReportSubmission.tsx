...
const ReportSubmission: React.FC = () => {
  ...
  const canProceedToNextStep = () => {
    switch (currentStep) {
      case 'basic':
        return watchedTitle && watchedCategory && watchedDescription &&
               watchedTitle.length >= 10 && watchedDescription.length >= 50;
      case 'datetime':
        return true; // Date/time is optional, location fields will be validated on submit
      case 'evidence':
